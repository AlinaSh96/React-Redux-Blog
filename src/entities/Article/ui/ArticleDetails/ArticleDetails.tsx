...
import { getArticleDatailsData, getArticleDatailsError, getArticleDatailsIsLoading }
...
export const ArticleDetails = memo((props: ArticleDetailsProps) => {
    ...
    const isLoading = useSelector(getArticleDatailsIsLoading);
    const error = useSelector(getArticleDatailsError);
